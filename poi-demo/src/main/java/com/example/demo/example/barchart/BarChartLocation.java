...
/**
 * 实现图表的精准定位实现图表的精准定位实现图表的精准定位
 */
public class BarChartLocation {

    public static void main(String[] args) throws Exception {

        final String returnurl = "D:\\youxi\\jx\\barchartresult.docx";  // 结果文件
        final String templateurl = "D:\\直真科技工作相关\\demo\\src\\main\\resources\\barchart.docx";  // 模板文件
    ...
    public static void doCharts1(Map<String, POIXMLDocumentPart> chartsMap) {
        ...
        // 注意这里的key值
        POIXMLDocumentPart poixmlDocumentPart = chartsMap.get("嘻嘻嘻嘻");
